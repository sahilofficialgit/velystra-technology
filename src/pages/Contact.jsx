      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            Have questions about our internships or coding challenges? Reach out
            to the Velystra team.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="bg-slate-900 text-white p-10 md:p-12 flex flex-col justify-between">
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              <p className="text-sm text-slate-400">
                Response Time: We typically respond to queries within 24-48
                hours.
              </p>
            </div>
          </div>
          ...
          <div className="p-10 md:p-12">
            ...
            <div className="bg-blue-50 text-blue-800 text-sm p-4 rounded-lg flex items-start gap-3 mb-8">
              ...
              <p>
                This contact form is currently in demonstration mode. Backend
                email services are being configured.
              </p>
            </div>
            ...
            {isSent ? (
              <div className="bg-green-50 border border-green-200 text-green-800 p-6 rounded-lg text-center">
                ...
                <p className="text-sm">
                  Thank you for reaching out. (Demo mode: no actual email was
                  sent).
                </p>
                <button

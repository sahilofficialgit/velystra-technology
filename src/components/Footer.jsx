        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-slate-500">
              Building practical skills through hands-on projects and developer communities.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/challenges" className="hover:text-blue-400 transition-colors">Coding Challenges</Link></li>
              <li><Link to="/verify" className="hover:text-blue-400 transition-colors">Verify Certificate</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href={`mailto:${SITE_CONFIG.contactEmail}`} className="hover:text-blue-400 transition-colors">
